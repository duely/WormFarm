...
@Config(modid = WormFarm.MODID)
@Mod.EventBusSubscriber(modid = WormFarm.MODID)
public class WFConfig {
    ...
    public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
        if (event.getModID().equals(WormFarm.MODID)) {
            ConfigManager.sync(WormFarm.MODID, Config.Type.INSTANCE);
            WormFarm.resolveClasses();
            ...
            if (Ocarina.functionality.getMaxUses() != Ocarina.functionality.maxUses)
                WormFarm.LOG.error(String.format("Invalid configuration value for Ocarina:maxUses: |%d|. Using default 0 instead.", Ocarina.functionality.maxUses));
            if (Ocarina.functionality.getCooldown() != Ocarina.functionality.cooldown)
                WormFarm.LOG.error(String.format("Invalid configuration value for Ocarina:cooldown: |%d|. Using default 0 instead.", Ocarina.functionality.cooldown));
            if (Ocarina.functionality.getSummonCost() != Ocarina.functionality.summonCost)
                WormFarm.LOG.error(String.format("Invalid configuration value for Ocarina:summonCost: |%d|. Using default 0 instead.", Ocarina.functionality.summonCost));
            if (EnchantedCarrot.durability.getMaxUses() != EnchantedCarrot.durability.maxUses)
                WormFarm.LOG.error(String.format("Invalid configuration value for EnchantedCarrot:maxUses: |%d|. Using default 1 instead.", EnchantedCarrot.durability.maxUses));
        }
    }
    ...
    public static class Proxies {
        ...
        public class Animania {
            ...
            @Config.Comment("Specify list of Animania classes that are considered steeds. Use /wormfarm entity while targetting to get the full name")
        ...
        public class ZAWA {
            ...
            @Config.Comment("Specify list of ZAWA Rebuilt classes that are considered steeds. Use /wormfarm entity while targetting to get the full name")
        ...
        public class Atum2 {
            ...
            @Config.Comment("Specify list of Atum 2 classes that are considered steeds. Use /wormfarm entity while targetting to get the full name")
        ...
        public class IceAndFire {
            ...
            @Config.Comment("Specify list of Ice and Fire classes that are considered steeds. Use /wormfarm entity while targetting to get the full name")
            ...
            @Config.Comment("Specify list of Ice and Fire classes that are excuded from Carrot taming, ageing and breeding. Use /wormfarm entity while targetting to get the full name")
